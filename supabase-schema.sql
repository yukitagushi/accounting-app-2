...
insert into public.branches (id, name, code, address, phone) values
  ('00000000-0000-0000-0000-000000000001', '本店', 'HQ', '〒100-0001 東京都千代田区千代田1-1-1', '03-1234-5678');
...
insert into public.app_settings (branch_id, company_name, company_address, company_phone, company_registration_number) values
  ('00000000-0000-0000-0000-000000000001', 'サンプル株式会社', '〒100-0001 東京都千代田区千代田1-1-1', '03-1234-5678', 'T0000000000000');

-- Sample customers
insert into public.customers (branch_id, customer_code, name, name_kana, address, phone, contact_person, payment_terms) values
  ('00000000-0000-0000-0000-000000000001', 'C-001', '株式会社サンプル商事', 'サンプルショウジ', '〒150-0001 東京都渋谷区神宮前1-1-1', '03-2000-0001', '佐藤 一郎', '月末締め翌月末払い'),
  ('00000000-0000-0000-0000-000000000001', 'C-002', 'デモ運送株式会社', 'デモウンソウ', '〒135-0061 東京都江東区豊洲2-2-2', '03-2000-0002', '田中 次郎', '月末締め翌月末払い'),
  ('00000000-0000-0000-0000-000000000001', 'C-003', 'テスト自動車株式会社', 'テストジドウシャ', '〒160-0023 東京都新宿区西新宿3-3-3', '03-2000-0003', '鈴木 三郎', '月末締め翌月15日払い'),
  ('00000000-0000-0000-0000-000000000001', 'C-004', '株式会社デモ建設', 'デモケンセツ', '〒106-0032 東京都港区六本木4-4-4', '03-2000-0004', '山田 四郎', '都度払い'),
  ('00000000-0000-0000-0000-000000000001', 'C-005', '株式会社サンプル物流', 'サンプルブツリュウ', '〒103-0027 東京都中央区日本橋5-5-5', '03-2000-0005', '高橋 五郎', '月末締め翌月末払い');
